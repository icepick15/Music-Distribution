...
const PricingPage = () => {
  ...
  const plans = [
    ...
    },
    {
      id: 'yearly',
      name: 'Yearly Premium',
      price: billingCycle === 'yearly' ? '₦39,900' : '₦4,200',
      originalPrice: billingCycle === 'yearly' ? '₦50,400' : null,
      period: billingCycle === 'yearly' ? 'per year' : 'per month',
      savings: billingCycle === 'yearly' ? 'Save ₦10,500' : null,
  ...
  const comparisonFeatures = [
    {
      ...
      features: [
        ...
        { name: 'Keep royalties', payPerSong: '90%', yearly: '95%' }
      ]
    },
    {
      category: 'Features',
